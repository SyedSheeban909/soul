...
FORWARD_CHANNEL_ID = -1002322065707
CHANNEL_ID = -1002322065707
error_channel_id = -1002322065707
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Please reach out to the owner for assistance: @In3aneOwner* 🙏"  # Contact owner message
    else:
